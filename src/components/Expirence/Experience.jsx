            ...
            <div className={style.proyect}>
              <div className={style.descripcion}>
                <p className={style.text}>
                  Group project consisting of a social network for programmers.
                  A collaborative platform that facilitates the creation of
                  posts about projects, interaction in communities, access to
                  ...
                  <br />
                  <span className={style.tecnologias}>Back:</span> Express,
                  Phyton y Django. <br />
                  <span className={style.tecnologias}>Database:</span>{" "}
                  PostgreSQL.
                </p>
              </div>
